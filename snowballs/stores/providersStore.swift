...
final class ProvidersStore: ObservableObject {
    ...
    func fetchAPIKey() -> String? {
        let key = KeychainManager.retrieveAPIKey(service: "snowballs", account: "openAI")
        return key
    }
    
    func saveAPIKey(forProvider: Provider, key: String) {
        KeychainManager.storeAPIKey(service: "snowballs", account: "openAI", apiKey: key)
    }
}
